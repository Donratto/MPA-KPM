...
// if rem > 0 then the part of the script related to rem will run
#define rem 0

int
main(int argc, char* argv[])
{
    std::string remMode = "BeamShape";
    ...
    cmd.AddValue("remMode",
                 "What type of REM map to use: BeamShape, CoverageArea or UeCoverage.\n"
